package com.sdenvi.gof23.algorithm;
...
public class WordTrie {
	 ...
	 * @return
	 */
	public LinkedList<String> pregSplit(String str) {
		Matcher matcher = Pattern.compile(chinesePattern).matcher(str);
